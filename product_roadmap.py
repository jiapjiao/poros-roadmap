...
@st.cache_data
def load_data():
    file_path = "PorosX.ai 公众号管理 (1).xlsx"   # ← 如果文件名不同，请修改这里
...
fig.add_vline(x=today, line_dash="dash", line_color="red", line_width=3,
...
st.caption("数据来源：PorosX.ai 公众号管理表格 | 修改Excel后重新运行即可更新")